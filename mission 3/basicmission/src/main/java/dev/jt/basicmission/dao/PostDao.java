package dev.jt.basicmission.dao;

import dev.jt.basicmission.dto.PostDto;
...
public class PostDao {
    ...
    public void updatePost(int id, PostDto dto){
        ...
        postEntity.setTitle(dto.getTitle() == null
                ? postEntity.getTitle() : dto.getTitle());
        postEntity.setContent(dto.getContent() == null
                ? postEntity.getContent() : dto.getContent());
        postEntity.setWriter(dto.getWriter() == null
                ? postEntity.getWriter() : dto.getWriter());
        this.postRepository.save(postEntity);
    }
